...
<div class="swiper" id="mainSwiper">
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide slide-gourmet-2">
      <div class="gourmet-container">
        <div class="gourmet-content">
          <h2 class="gourmet-title">ビュッフェ情報</h2>
          <p class="gourmet-subtitle">朝食・夕食で楽しむ絶品グルメ</p>
          ...
          <div class="buffet-info">
            <div class="buffet-time">
              <h4>営業時間</h4>
              <p>朝食：7:00〜10:00 / 夕食：17:30〜21:00</p>
              <small>※最終入場は終了30分前</small>
            </div>
            <div class="buffet-feature">
              <h4>夏限定特別企画</h4>
              <p>地元産食材を使った特別メニューをご用意</p>
            </div>
          </div>
        </div>
      </div>
