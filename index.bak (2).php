...
/* Modern Swipe Animations - Desktop only */
...
/* No animations for gourmet titles - always visible */
.gourmet-title,
.gourmet-subtitle {
  opacity: 1 !important;
  transform: none !important;
...
/* Video will be controlled by connection speed via JavaScript */
...
/* Sky Pool - no animations for content visibility */
.skypool-badge {
...
@media (max-width: 768px) {
  /* Keep vertical pagination on mobile but make it more visible */
  .swiper-pagination {
...
function handleVideoBasedOnConnection() {
  ...
  if ('connection' in navigator && navigator.connection) {
    ...
    if (saveData || effectiveType === 'slow-2g' || effectiveType === '2g') {
      ...
      heroBg.style.background = "url('summer/images/hero-bg.jpg') center/cover";
    } else {
